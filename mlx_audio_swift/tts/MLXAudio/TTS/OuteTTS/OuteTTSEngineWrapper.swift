...
/// OuteTTS engine - voice cloning TTS with speaker profiles
@Observable
@MainActor
public final class OuteTTSEngineWrapper: TTSEngine {
    ...
    /// Path to custom speaker profile (for voice cloning)
    ...
    /// Load a custom speaker profile for voice cloning
    ...
    private func resolveSpeaker() -> OuteTTSSpeakerProfile? {
        ...
        case "default":
            // Default speaker is loaded by OuteTTSEngine from HuggingFace
            return nil
        case "custom":
