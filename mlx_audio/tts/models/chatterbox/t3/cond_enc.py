...
class T3CondEnc(nn.Module):
    ...
    def __call__(self, cond: T3Cond) -> mx.array:
        ...
        assert has_tokens == has_emb, "cond_prompt_speech_tokens and cond_prompt_speech_emb must both be provided or both be None"
        ...
        if self.hp.emotion_adv:
            assert cond.emotion_adv is not None, "emotion_adv must be provided when hp.emotion_adv is True"
            # Reshape to (B, 1, 1)
