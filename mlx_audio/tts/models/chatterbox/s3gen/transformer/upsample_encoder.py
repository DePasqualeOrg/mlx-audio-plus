...
def make_pad_mask(lengths: mx.array, max_len: int = 0) -> mx.array:
    ...
    seq_range_expand = mx.broadcast_to(seq_range_expand, (batch_size, max_len))  # (B, T)
...
class UpsampleConformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        if selfattention_layer_type == "rel_selfattn":
            ...
            raise ValueError(f"Unsupported selfattention_layer_type: {selfattention_layer_type}")
