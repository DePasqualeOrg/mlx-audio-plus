...
class ConvRNNF0Predictor(nn.Module):
    ...
    def __init__(
        ...
        self.condnet = [
            nn.Conv1d(in_channels, cond_channels, kernel_size=3, padding=1),      # condnet.0
            nn.Conv1d(cond_channels, cond_channels, kernel_size=3, padding=1),    # condnet.2
            nn.Conv1d(cond_channels, cond_channels, kernel_size=3, padding=1),    # condnet.4
            nn.Conv1d(cond_channels, cond_channels, kernel_size=3, padding=1),    # condnet.6
            nn.Conv1d(cond_channels, cond_channels, kernel_size=3, padding=1),    # condnet.8
        ]
